...
public class PhotoPickerActivity extends Activity implements PhotoAdapter.PhotoClickCallBack {
     ...
     * 获取照片的异步任务
     */
    private AsyncTask<String,String,String> getPhotosTask = new AsyncTask<String,String,String>() {
       static   final String success="true";
        ...
        protected void onPostExecute(String result) {
            if (result.equals(success)) {
                ...
                Toast.makeText(PhotoPickerActivity.this,"访问图库失败",Toast.LENGTH_SHORT).show();
