...
public class EarlyWarningDetailActivity extends BaseActivity<BasePresenter,ActivityEarlyWarningDetailBinding> {
    ...
    protected void initData() {
        ...
        mBinding.affirm1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Api.getApi().getearlyRecordUpdate2("" + MyApplication.getInstance().getUserData().getPrincipal().getUserId(),"4",MyApplication.getInstance().getUserData().getName(),mId)
                        .compose(callbackOnIOToMainThread())
                        .subscribe(new BaseNetListener<BaseBean>(EarlyWarningDetailActivity.this, true) {
                            @Override
                            public void onSuccess(BaseBean baseBean) {
        ...
        mBinding.affirm2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Api.getApi().getearlyRecordUpdate2("" + MyApplication.getInstance().getUserData().getPrincipal().getUserId(),"3",MyApplication.getInstance().getUserData().getName(),mId)
                        .compose(callbackOnIOToMainThread())
                        .subscribe(new BaseNetListener<BaseBean>(EarlyWarningDetailActivity.this, true) {
                            @Override
                            public void onSuccess(BaseBean baseBean) {
