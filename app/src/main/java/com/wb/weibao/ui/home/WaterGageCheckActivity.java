 ...
 * 用水-水压检测
 */
public class WaterGageCheckActivity extends BaseActivity<BasePresenter, ActivityWaterGageCheckBinding> {
    ...
    private void getWaterList() {
        Api.getApi().getWaterList(MyApplication.getInstance().getProjectId(), "10004")
