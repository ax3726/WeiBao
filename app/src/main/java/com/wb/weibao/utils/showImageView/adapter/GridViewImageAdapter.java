...
public class GridViewImageAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context).load(gridItemList.get(position)).diskCacheStrategy(DiskCacheStrategy.ALL).crossFade().thumbnail(0.1f).error(R.drawable.image_error).placeholder(R.mipmap.ic_launcher).into(viewHolder.image);
