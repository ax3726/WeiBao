...
public class ClockView extends View {
    ...
    private static final int DEFAULT_COLOR_LOWER = Color.BLACK;
    private static final int DEFAULT_COLOR_MIDDLE = Color.BLACK;
    private static final int DEFAULT_COLOR_HIGH = Color.BLACK;
    ...
    private static final int DEFAULT_ANIM_PLAY_TIME = 1000;
    ...
    private void drawArc(Canvas canvas) {
        ...
        canvas.drawArc(mRect, 0, 360, false, arcPaint);
    ...
    private void drawPointerLine(Canvas canvas) {
        canvas.rotate(135);
        for (int i = 0; i < 51; i++) {     //一共需要绘制101个表针
    ...
    private void drawPointerText(Canvas canvas, int i) {
        ...
        canvas.drawText(String.valueOf(FloatCalculator.multiply(i, 0.02f)), 0, textBaseLine, pointerPaint);
        canvas.restore();
    }
...
//        canvas.drawText(titleDial, 0, -radiusDial / 3, titlePaint);
        canvas.drawText(titleDial, 0, radiusDial * 2 / 3, titlePaint);
    ...
    private void drawPointer(Canvas canvas) {
        int currentDegree = (int) (FloatCalculator.add(FloatCalculator.multiply(currentValue, 5.4f), 137));
        canvas.rotate(currentDegree);

        pointerPath.moveTo(radiusDial - strokeWidthDial - dp2px(12), 0);
        pointerPath.lineTo(0, -dp2px(3));
        pointerPath.lineTo(-dp2px(9), 0);
        pointerPath.lineTo(0, dp2px(3));
        pointerPath.close();
