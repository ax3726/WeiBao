...
package com.wb.weibao.widget.zxing.camera;
...
public final class CameraManager {
	 ...
	 * 重新对焦
	 */
	public synchronized void restartAutoFocus()
	{
...
//					MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
			int width= (int) (screenResolution.x*0.7f);
			int height=width;
			/*int width = findDesiredDimensionInRange(screenResolution.x,
			...
			int topOffset = (screenResolution.y - height) / 2-AutoUtils.getPercentHeightSize(60);
